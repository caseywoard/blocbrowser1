...
- (void)loadView {
    ...
    */
    ...
    // replacing the code above with a for-loop...
...
- (void)viewDidLoad {
    ...
    // navigationItem.rightBarButtonItem -- research
...
- (void) viewWillLayoutSubviews {
    ...
    // placement of the bottom nav buttons
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField {
    ...
    // if user enters blank spaces let's assume google search
    
    NSString *usersQuery = textField.text;
    NSRange findBlankSpaces = [usersQuery rangeOfString:@" "];

    if (findBlankSpaces.location != NSNotFound) {
        
        NSString *usersQueryFormattedForGoogle = [usersQuery stringByReplacingCharactersInRange:findBlankSpaces withString:@"+"]; //get error that range is out of bounds.
        
        NSString *searchQueryString = [NSString stringWithFormat:@"http://www.google.com/search?q=%@", usersQueryFormattedForGoogle];
        NSURL *searchQuery = [NSURL URLWithString:searchQueryString];
        NSURLRequest *googleSearch = [NSURLRequest requestWithURL:searchQuery];
        [self.webview loadRequest:googleSearch];
